...
const NavBar = () => {
  ...
  return !user ? (
    ...
    <div className="lg:w-[calc(100vw-240px)] lg:ml-60 w-screen min-h-screen bg-gray-50">
      {/* Enhanced Header */}
      <div className="flex h-16 bg-gradient-to-r from-teal-600 to-emerald-600 lg:w-[calc(100vw-240px)] justify-between items-center w-screen px-6 shadow-lg">
      ...
      <div className="lg:w-[calc(100vw-240px)] bg-gradient-to-br from-gray-50 to-blue-50/30 min-h-[calc(100vh-4rem)] w-screen p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-[calc(100vh-7rem)] p-6">
          <Outlet />
        </div>
      </div>
    </div>
