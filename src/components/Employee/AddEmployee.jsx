        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <div className="flex max-sm:flex-col">
              <div className="flex flex-col">
                <label
                  className="font-bold text-sm ml-4 mt-6"
                  htmlFor="address"
                >
                  Address
                </label>
            ...
            <div className="flex max-sm:flex-col">
              ...
              <div className="flex flex-col">
                <label className="font-bold mt-6 text-sm ml-4 " htmlFor="image">
                  upload Image
                </label>
                <input
                  onChange={hadleChange}
            ...
            <button className=" px-10 rounded-sm py-3 border lg:w-255 md:w-60 sm:w-40 ml-4  bg-teal-700 mt-10 font-bold text-white cursor-pointer ">
              Add Employee
            </button>
          </div>
        </form>
