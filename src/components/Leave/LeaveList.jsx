...
const LeaveList = () => {
  ...
  const enhancedLeaveColumns = useMemo(() => [
    ...
    },
    {
      ...
      minWidth: "150px",
      cell: row => (
        <span className="text-xs text-gray-600 line-clamp-1 truncate" title={row.description}>
          {row.description}
        </span>
      ),
    ...
    },
    {
      ...
      cell: row => {
        ...
        return (
          <div className={`inline-flex items-center gap-1 px-2 py-1 rounded-full border ${config.color}`}>
        ...
        <div className="flex gap-1">
          ...
          {row.status === "pending" && (
            <button
              ...
              className="px-2 py-1 text-xs bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors duration-200"
            >
              Cancel
            </button>
          )}
  ...
  const handleCancelLeave = (leave) => {
    if (window.confirm(`Are you sure you want to cancel this ${leave.leave} leave?`)) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 p-3 sm:p-4 lg:p-6">
          ...
          >
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="p-2 bg-blue-100 rounded-lg flex-shrink-0">
                <Bell size={18} className="text-blue-600 sm:w-5 sm:h-5 w-4 h-4" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-semibold text-gray-900 text-base sm:text-lg">Important Notices</h3>
                  <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm text-gray-700">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="break-words">Submit leave applications at least 3 days in advance</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <AlertCircle size={14} className="text-orange-500 flex-shrink-0 mt-0.5" />
                    <span className="break-words">Emergency leaves require immediate manager approval</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <AlertCircle size={14} className="text-purple-500 flex-shrink-0 mt-0.5" />
                    <span className="break-words">Check your remaining leave balance before applying</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <AlertCircle size={14} className="text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="break-words">All leaves are subject to company policy approval</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <motion.div
        ...
        className={`bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6 ${showMobileFilters ? 'block' : 'hidden lg:block'}`}
      >
        ...
        {loading ? (
          <div className="flex justify-center items-center py-12 sm:py-20">
            <div className="text-center">
              <Loader />
              <p className="text-gray-600 mt-4 text-sm sm:text-base">Loading your leave data...</p>
            </div>
          </div>
        ) : (
          <>
              ...
              <DataTable
                ...
                noDataComponent={
                  <div className="flex flex-col items-center justify-center py-8 sm:py-12 text-gray-500">
                    <Calendar size={32} className="mb-3 text-gray-300 sm:w-12 sm:h-12 w-8 h-8" />
                    <p className="text-base sm:text-lg font-medium mb-2 text-center">No leave records found</p>
                    <p className="text-xs sm:text-sm text-center">Start by applying for your first leave</p>
                  </div>
                }
              />
            </div>
            ...
            {leaveFilter.length > 0 && (
              <div className="px-4 sm:px-6 py-3 bg-gray-50 border-t border-gray-200">
                <p className="text-xs sm:text-sm text-gray-600 text-center sm:text-left">
                  Showing {leaveFilter.length} of {leaveData.length} leave records
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0">
              <h3 className="text-lg sm:text-xl font-bold mb-1 truncate">Join Our Growing Team!</h3>
              <p className="opacity-90 text-xs sm:text-sm line-clamp-2">
                Explore exciting career opportunities and become part of our success story
              </p>
            </div>
          </div>
      ...
      <motion.div
        ...
        className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6"
      >
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-200">
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            <div className="p-2 bg-blue-100 rounded-lg flex-shrink-0">
              <Users size={16} className="text-blue-600 sm:w-5 sm:h-5 w-4 h-4" />
            </div>
            <h4 className="font-semibold text-gray-900 text-sm sm:text-base">HR Support</h4>
          </div>
          <p className="text-xs sm:text-sm text-gray-600">
            Contact HR for leave policy queries or special leave requests.
          </p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-200">
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            <div className="p-2 bg-green-100 rounded-lg flex-shrink-0">
              <CheckCircle size={16} className="text-green-600 sm:w-5 sm:h-5 w-4 h-4" />
            </div>
            <h4 className="font-semibold text-gray-900 text-sm sm:text-base">Quick Approval</h4>
          </div>
          <p className="text-xs sm:text-sm text-gray-600">
            Most leaves are approved within 24-48 hours of application.
          </p>
        </div>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-200">
          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
            <div className="p-2 bg-orange-100 rounded-lg flex-shrink-0">
              <AlertCircle size={16} className="text-orange-600 sm:w-5 sm:h-5 w-4 h-4" />
            </div>
            <h4 className="font-semibold text-gray-900 text-sm sm:text-base">Emergency Leave</h4>
          </div>
          <p className="text-xs sm:text-sm text-gray-600">
            For urgent leaves, contact your manager directly for immediate approval.
          </p>
        </div>
      </motion.div>
    </div>
